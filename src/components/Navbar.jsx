                ...
                <nav className={`py-3 lg:px-14 px-4 bg-transparent ${isSticky ? "backdrop-blur-md sticky top-0 left-0 right-0 border-white bg-duration-300" : ""} `}> {/*if want border-b*/}
                    <div className='flex justify-between items-center text-base gap-8 border-b-2 border-b-brandPrimary py-4'>
                        ...
                        <div className='space-x12 hidden lg:flex items-center'>
                            <a href="/" className=' lg:px-8 px-2 py-1 lg:flex items-center text-brandPrimary hover:text-black  hover:bg-brandPrimary rounded-2xl outline mx-5'>LOGIN</a>
                            <button className='bg-transparent text-brandPrimary py-1 lg:px-8 px-1 transition-all-during-300 rounded-2xl hover:text-black hover:bg-brandPrimary  outline mx-3' >SIGN UP</button>
                        </div>
